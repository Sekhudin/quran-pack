import Quran from '../dist';

describe("[dist] Qur'an defined and match properties - surah Al-Fatihah", () => {
...
describe("[dist] Qur'an defined and match properties - surah Al-Jumu'ah", () => {
  test('using contructor with string name of surah (ID)', () => {
